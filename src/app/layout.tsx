        ...
        <footer className="mt-auto w-full p-4 md:p-6 lg:p-8 z-10">
          <div className="max-w-7xl mx-auto relative overflow-hidden rounded-[2.5rem] md:rounded-[3rem] border border-[color:var(--panel-edge)] bg-gradient-to-b from-[color:var(--panel-strong)]/90 to-[color:var(--panel)]/90 backdrop-blur-2xl shadow-2xl shadow-emerald-900/5">
            ...
            <div className="relative z-10 px-6 py-8 md:px-12 lg:py-16">
              <div className="grid grid-cols-2 gap-x-4 gap-y-8 md:gap-8 md:grid-cols-4 relative">
                {/* Subtle vertical separators for desktop */}
                <div className="hidden md:block absolute left-1/4 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[color:var(--panel-edge)] to-transparent" />
                <div className="hidden md:block absolute left-2/4 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[color:var(--panel-edge)] to-transparent" />
                <div className="hidden md:block absolute left-3/4 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[color:var(--panel-edge)] to-transparent" />
              ...
              <div>
                <h5 className="text-sm font-semibold text-[color:var(--foreground)]">Operations</h5>
                <ul className="mt-3 space-y-2 text-sm text-[color:var(--muted)]">
                  <li><a className="hover:text-[color:var(--foreground)]" href="#">Dispatch Center</a></li>
                  <li><a className="hover:text-[color:var(--foreground)]" href="#">Fleet Registry</a></li>
                  <li><a className="hover:text-[color:var(--foreground)]" href="#">Maintenance Intel</a></li>
                  <li><a className="hover:text-[color:var(--foreground)]" href="#">Incident Logs</a></li>
                </ul>
              </div>

              <div>
                <h5 className="text-sm font-semibold text-[color:var(--foreground)]">Resources</h5>
                <ul className="mt-3 space-y-2 text-sm text-[color:var(--muted)]">
                  <li><a className="hover:text-[color:var(--foreground)]" href="#">Command Manual</a></li>
                  <li><a className="hover:text-[color:var(--foreground)]" href="#">Driver Quickstart</a></li>
                  <li><a className="hover:text-[color:var(--foreground)]" href="#">Security Brief</a></li>
                  <li><a className="hover:text-[color:var(--foreground)]" href="#">Support Desk</a></li>
                </ul>
              </div>
