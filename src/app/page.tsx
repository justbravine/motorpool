...
export default function Home() {
  return (
    <div className="min-h-screen font-sans relative app-shell flex flex-col bg-[color:var(--background)]">
      <nav className="absolute top-0 left-0 right-0 z-50 p-2 sm:p-4 md:p-6">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 py-2 sm:py-3 md:py-4 flex items-center justify-between rounded-full border border-transparent transition-all duration-500 hover:bg-[color:var(--panel)]/95 hover:backdrop-blur-xl hover:shadow-2xl hover:shadow-emerald-900/20 hover:border-emerald-500/20">
